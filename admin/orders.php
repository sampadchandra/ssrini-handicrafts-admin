        ...
        */
        ...
        if (
            ...
            if (
                ...
                $errorMessage =
                    'Order status cannot be updated because the required database columns are missing.';
        ...
        */
        ...
        elseif (
            ...
            if (
                ...
                $errorMessage =
                    'Order cannot be deleted because the required database columns are missing.';
...
if (
    ...
    */
    ...
    $selectParts[] =
        "o.`$orderIdColumn` AS order_id";

    if ($orderNumberColumn) {

        $selectParts[] =
            "o.`$orderNumberColumn` AS order_number";
    ...
    if ($customerIdColumn) {
        ...
        $selectParts[] =
            "o.`$customerIdColumn` AS customer_id";
    ...
    if ($customerNameColumn) {
        ...
        $selectParts[] =
            "o.`$customerNameColumn` AS customer_name";
    ...
    if ($customerPhoneColumn) {
        ...
        $selectParts[] =
            "o.`$customerPhoneColumn` AS customer_phone";
    ...
    if ($customerEmailColumn) {
        ...
        $selectParts[] =
            "o.`$customerEmailColumn` AS customer_email";
    ...
    if ($shippingColumn) {
        ...
        $selectParts[] =
            "o.`$shippingColumn` AS shipping_amount";
    ...
    if ($discountColumn) {
        ...
        $selectParts[] =
            "o.`$discountColumn` AS discount_amount";
    ...
    if ($statusColumn) {
        ...
        $selectParts[] =
            "o.`$statusColumn` AS order_status";
    ...
    if ($paymentMethodColumn) {
        ...
        $selectParts[] =
            "o.`$paymentMethodColumn` AS payment_method";
    ...
    if ($paymentStatusColumn) {
        ...
        $selectParts[] =
            "o.`$paymentStatusColumn` AS payment_status";
    ...
    if ($addressColumn) {
        ...
        $selectParts[] =
            "o.`$addressColumn` AS shipping_address";
    ...
    if ($updatedAtColumn) {
        ...
        $selectParts[] =
            "o.`$updatedAtColumn` AS updated_at";
    ...
    */
    ...
    if (
        ...
        if (
            ...
            $selectParts[] =
                "c.`$customersNameColumn` AS joined_customer_name";
        ...
        if (
            ...
            $selectParts[] =
                "c.`$customersPhoneColumn` AS joined_customer_phone";

        } else {

            $selectParts[] =
                "NULL AS joined_customer_phone";
        }
        ...
        if (
            ...
            $selectParts[] =
                "c.`$customersEmailColumn` AS joined_customer_email";
    ...
    if (
        ...
        if ($orderItemsQuantityColumn) {
            ...
            $selectParts[] =
                ...
                (
                    SELECT COALESCE(
                        SUM(oi_count.`$orderItemsQuantityColumn`),
                        0
                    )
                    FROM order_items oi_count
                    WHERE oi_count.`$orderItemsOrderIdColumn`
                        = o.`$orderIdColumn`
                ) AS item_count
                ";
    ...
    */
    ...
    if (
        ...
        if (
            ...
            $searchParts[] =
                "o.`$orderNumberColumn` LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "o.`$customerNameColumn` LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "o.`$customerPhoneColumn` LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "o.`$customerEmailColumn` LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "CAST(o.`$customerIdColumn` AS CHAR) LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "c.`$customersNameColumn` LIKE :search";
        }
        ...
        if (
            ...
            $searchParts[] =
                "c.`$customersPhoneColumn` LIKE :search";
        }
    ...
    */
    ...
    if (
        ...
        $where[] =
            "LOWER(o.`$statusColumn`) = :status_filter";
    ...
    */
    ...
    if (
        ...
        $where[] =
            "LOWER(o.`$paymentMethodColumn`) = :payment_filter";
    ...
    */
    ...
    if (
        ...
        if (
            ...
            $where[] =
                "DATE(o.`$createdAtColumn`) = :date_filter";
...
<head>
    ...
    <meta
        name="description"
        content="Ssrini Handicrafts Orders Management"
    >
        ...
        <div class="page-content">
            ...
            <div class="orders-page">
                ...
                <?php if ($successMessage !== ''): ?>
                    ...
                    <div
                        class="orders-alert orders-alert-success"
                    >
                        <?= e($successMessage) ?>
                    </div>
                ...
                <?php if ($errorMessage !== ''): ?>
                    ...
                    <div
                        class="orders-alert orders-alert-error"
                    >
                        <?= e($errorMessage) ?>
                    </div>
                    ...
                    <?php elseif (empty($orders)): ?>
                        ...
                        <div class="orders-empty">
                            ...
                            <p>
                                ...
                                if you expected to see an order.
                            </p>
...
function openOrderModal(order) {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The main order page already displays
    | item count. Detailed item rows can be
    | loaded from a dedicated order API later
        ...
        <div class="order-item">
            <div>
                ...
                <div class="order-item-meta">
                    View the complete order item details
