 ...
 *
 * Purpose:
 * View a complete invoice/order invoice.
 *
 * Expected URL:
 * invoice-view.php?id=1
 *
 * =========================================================
 */
 ...
 *
 * This keeps the invoice page compatible
 * with the existing database naming.
 */
...
if ($invoiceId <= 0) {
    ...
    <head>
        ...
        <title>
            Invalid Invoice | Ssrini Handicrafts
        </title>
    ...
    <body>
        ...
        <div class="error-box">
            ...
            <p>
                No valid invoice ID was provided.
            </p>
...
if (!$invoice) {
    ...
    <head>
        ...
        <title>
            Invoice Not Found | Ssrini Handicrafts
        </title>
...
<head>
    ...
    <meta
        name="description"
        content="Invoice View | Ssrini Handicrafts"
    >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="invoice-brand-name"
                            >
                                Ssrini Handicrafts
                            </div>

                            <div
                                class="invoice-brand-subtitle"
                            >
                    ...
                    >
                        ...
                        <div
                            class="invoice-meta-box"
                        >

                            <div
                                class="invoice-meta-label"
                            >
                                Invoice Date
                            </div>

                            <div
                                class="invoice-meta-value"
                            >
                                <?= e(
                                    formatDate(
                                        $invoiceDate
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="invoice-notes-text"
                            >

                                Thank you for shopping
                                with Ssrini Handicrafts.
