...
if (
    ...
    $newOrderStatus = isset(
        $_POST['order_status']
    )
        ? trim($_POST['order_status'])
        : '';

    $newPaymentStatus = isset(
...
$updateSuccess = isset($_GET['success'])
    ? trim($_GET['success'])
    : '';

$updateError = isset($_GET['error'])
    ? trim($_GET['error'])
    : '';
...
if (!$order) {
    ...
    <head>
        ...
        <meta
            name="description"
            content="Order details - Ssrini Handicrafts Admin Panel"
        >

        <title>
            Order Not Found | Ssrini Handicrafts
        </title>
